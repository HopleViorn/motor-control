...
*******************************************************************************/
   ...
   #define CO_DEFAULT_TYPE_SIZE 0xFFFF      //for 8-bit microcontroller use 0xFF, for 16-bit use 0xFFFF
   ...
   #define CO_IDENT_READ_COB(CanMessage_Ident)   ((CanMessage_Ident.BYTE[0]) >> 5)  //inverse function, read COB-ID
   #define CO_IDENT_READ_RTR(CanMessage_Ident)   (CanMessage_Ident.BYTEbits[0].bit4)//inverse function, read RTR

   //reset microcontroller
   #define CO_Reset()  Reset_SYS()
   ...
   //enable, disable interrupts - VERY IMPORTANT SECTION
      ...
      #define CO_DISABLE_CANTX()          //ECanbRegs.CANMIM.bit.MIM8 = 0;//INTCONbits.GIEL = 0
      #define CO_ENABLE_CANTX()           //ECanbRegs.CANMIM.bit.MIM8 = 1;//INTCONbits.GIEL = 1
   ...
   //Read Transmit Buffer Status
      #define CO_CANTX_BUFFER_FREE()      (ECanbRegs.CANES.bit.TM == 0 )//&& ECanbRegs.CANTRS.bit.TRS8==0 &&ECanbRegs.CANTRR.bit.TRR8==0&& ECanbRegs.CANTA.bit.TA8==0)//(TXB0CONbits.TXREQ == 0)
#endif
