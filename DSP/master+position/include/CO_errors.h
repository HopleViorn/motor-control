...
#define _ERRORS_H
   ...
   #define ERROR_NO_OF_BYTES 8      //4...32

/***** Table of standard error codes (DS 301) *********************************/
   //Each error code value corresponds one error bit
   #define ERROR_CODES {\
   	  0x0000, 0x6100, 0x6110, 0x6120, 0x6000, 0x6300, 0x0000, 0x0000, \
   	  0x8110, 0x8140, 0x8120, 0x8100, 0x0000, 0x8100, 0x8130, 0x8100, \
   	  0x1001, 0x1002, 0x1003, 0x1004, 0x1005, 0x1006, 0x1007, 0x1008, \
   	  0x8210, 0x8200, 0x8200, 0x8200, 0x0000, 0x8100, 0x8100, 0x0000, \
   	  0x2310, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, \
   	  0x3100, 0x3110, 0x3120, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, \
   	  0x5080, 0x5210, 0x5420, 0x5421, 0x5581, 0x5582, 0x5583, 0x0000, \
   	  0x7305, 0x7303, 0x7380, 0x0000, 0x0000, 0x0000, 0x8311, 0x8480 }
/**/
/***** definitions for Error Status Bits **************************************/
   ...
   #define ERROR_CAN_OVERFLOW       		          0x08
   #define ERROR_CAN_BUS_OFF                          0x09
   #define ERROR_CAN_BUS_PASSIVE                      0x0A
   #define ERROR_CAN_FE_BE_CRCE_SE_ACKE               0x0B
   #define ERROR_CAN_RESV                             0x0C
   ...
   //byte 4, important current errors
   #define ERROR_OVER_CURRENT                     	  0x20	// A.12
   #define ERROR_CURRENT_1                     		  0x21
   #define ERROR_CURRENT_2                            0x22
   #define ERROR_CURRENT_3                      	  0x23
   #define ERROR_CURRENT_4                            0x24
   #define ERROR_CURRENT_5                            0x25
   #define ERROR_CURRENT_6                            0x26
   #define ERROR_CURRENT_7                            0x27

   //byte 5, important voltage errors
   #define ERROR_MAIN_VOLTAGE_STOP                    0x28	// A.21
   #define ERROR_MAIN_OVER_VOLTAGE                    0x29	// A.13
   #define ERROR_MAIN_UNDER_VOLTAGE                   0x2A	// A.14
   #define ERROR_VOLTAGE_3                     		  0x2B
   #define ERROR_VOLTAGE_4                     		  0x2C
   #define ERROR_VOLTAGE_5                            0x2D
   #define ERROR_VOLTAGE_6                            0x2E
   #define ERROR_VOLTAGE_7                            0x2F

   //byte 6, device errors
   #define ERROR_RAM                    		  	  0x30	// A.80
   #define ERROR_ADC                     			  0x31	// A.02 08 09
   #define ERROR_XIEFANG                     		  0x32	// A.15 16
   #define ERROR_ZAISHENG                    		  0x33	// A.01
   #define ERROR_SUMCHECK                             0x34	// A.07
   #define ERROR_GEAR                             	  0x35	// A.
   #define ERROR_MOTORSEL                             0x36	// A.
   #define ERROR_DEVICE0_7                            0x37	// A.

   //byte 7, 
   #define ERROR_INCREAME_PG                  		  0x38	// A.10  11 30 31 32
   #define ERROR_SPG                      			  0x39	// A.50 ~ 57
   #define ERROR_RESOLVER                      	      0x3A	// A.
   #define ERROR_DEVICE1_3                     		  0x3B	// A.
   #define ERROR_DEVICE1_4                      	  0x3C	// A.
   #define ERROR_DEVICE1_5                            0x3D	// A.
   #define ERROR_OVER_TORQE                           0x3E	// A.04
   #define ERROR_OVER_SPEED                           0x3F	// A.03

/***** calculation of Error register 0x1001 ***********************************/
   //generic error
   #define ERROR_REGISTER_BIT0_CONDITION (CO_ErrorStatusBits[0] & 0x3E)
   //current
   #define ERROR_REGISTER_BIT1_CONDITION (CO_ErrorStatusBits[4] & 0x01)
   //voltage
   #define ERROR_REGISTER_BIT2_CONDITION (CO_ErrorStatusBits[5] & 0x07)
   //temperature
   #define ERROR_REGISTER_BIT3_CONDITION (CO_ErrorStatusBits[0] & 0x00)
   //communication error
   #define ERROR_REGISTER_BIT4_CONDITION (CO_ErrorStatusBits[1] & 0xEF || CO_ErrorStatusBits[3] & 0x6F)
   //device profile specific
   #define ERROR_REGISTER_BIT5_CONDITION (CO_ErrorStatusBits[6] & 0x3F || CO_ErrorStatusBits[7] & 0xC7)
