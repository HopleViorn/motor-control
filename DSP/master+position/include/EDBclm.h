...
#define ParSpdADD			84		// 参数速度
#define JOGSPDADD			85		// JOG�ٶ�
#define SoftAccTimeADD		86		// 软加速时间
#define SoftDecTimeADD		87		// 软减速时间
...
#define	HzConversADD		313		// 增益换算系数���浥λת��
#define IPMImaxADD			314		// mokuai电流
#define MaxSpeedADD			315		// // 最高转速
#define JMotorADD			316		// ����������
#define InormalADD			317		//   额定电流 重要
...
#define RatedSpeedADD		328		// 额定转速
#define ImagneticADD		329		// �Ŷ����
#define MotorTab			330		// �ǷE�ȡ����������

#define ResorverBitADD       332     //
#define EncodeLineADD       333     //
...
struct intflag2{
					...
					Uint16 SciFindInitPhase:1;	// ͨ通讯找到初始相位
					Uint16 SciAnAutoWrFRAM:1;	// 校零引起的写FRAM
					Uint16 rFshROM:1;		// 读已完成
					Uint16 PgIniti:1;		// 编码器初始化标志编码器初始化标志־

					Uint16 pos_jogen:1;		// 位置JOG使能
					Uint16 wEEPROM:1;
					Uint16 rEEPROM:1;
					Uint16 PgPosIniti:1;
