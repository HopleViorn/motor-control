...
void InitXintf(void)
{
    ...
    // All Zones---------------------------------
    // Timing for all zones based on XTIMCLK = 1/2 SYSCLKOUT (SYSCLKOUT)
    EALLOW;
    ...
    // Lead must always be 1 or greater
    // Zone write timing
    XintfRegs.XTIMING6.bit.XWRLEAD = 2;		//3
    XintfRegs.XTIMING6.bit.XWRACTIVE = 2;	//7
    XintfRegs.XTIMING6.bit.XWRTRAIL = 2;	//3
    // Zone read timing
    XintfRegs.XTIMING6.bit.XRDLEAD = 2;		//3
    XintfRegs.XTIMING6.bit.XRDACTIVE = 2;	//7
    XintfRegs.XTIMING6.bit.XRDTRAIL = 1;	//3
...
//    XintfRegs.XBANK.bit.BCYC = 6;
    ...
    // Lead must always be 1 or greater
    // Zone write timing
    XintfRegs.XTIMING7.bit.XWRLEAD = 2;		//1
    XintfRegs.XTIMING7.bit.XWRACTIVE = 2;	//1
    XintfRegs.XTIMING7.bit.XWRTRAIL = 2;	//1
    // Zone read timing
    XintfRegs.XTIMING7.bit.XRDLEAD = 2;		//1
    XintfRegs.XTIMING7.bit.XRDACTIVE = 2;	//1
    XintfRegs.XTIMING7.bit.XRDTRAIL = 1;	//0
