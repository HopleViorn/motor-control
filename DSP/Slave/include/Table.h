...
//	����������Сֵ�����ֵ������ֵ 		// 0: unsigned ; 1: signed ; 2: bit ; 3: hex
		...
		1, 0xFC18,	 1000,	    0,	// Pn081:	Pn301 ģ���ٶȸ������ƫ��
		0,		0,	    0,	  	0,	// Pn082:	����
		0,		0,	    0,	  	0,	// Pn083:	����
		0,      0,	 16500,	  500,	// Pn084:	Pn304 �����ٶ�
		0, 		0,	 6000,	  500,	// Pn085:	Pn305 JOG�ٶ�
		0,      0,	99999,		0,	// Pn086:	Pn306 软启动加速时间
		0, 		0,	99999,		0,	// Pn087:	Pn307 软启动减速时间  8000
		...
		0, 		0,	  300,	  500,	// Pn104:	Pn401 最大正转扭矩限制  %
		0, 		0,	  300,	  500,	// Pn105:	Pn402 最大反转扭矩限制
		0, 		0,	  300,	  100,	// Pn106:	Pn403 最大外部扭矩限制
		0, 		0,	  300,	  100,	// Pn107:	Pn404  最大外部扭矩限制
		...
		1, 0xFC18,	 1000,	    0,	// Pn118:	Pn415 ģ��ת�ظ������ƫ��
		0, 		0,	 	0,		0,	// Pn119:	Pn416 ����
		...
		3, 		0, 0x0182, 0x0162,	// Pn252:	Pn700 SCIͨѶ��ز���
									...
									//			         hex2:ͨѶЭ��ѡ��hex3:����]
		0, 		1,    247,		2,	// Pn253:	Pn701 MODBUS���ַ
		...
		0, 		0,	 1000,	  600,	// Pn274:	Pn802 �첽�϶�Uq��ֵ
		0, 		0,	30000,	  30,	// Pn275:	Pn803 �额定Tn  几千W电机一般几十
		0, 		0,	 4096,	  205,	// Pn276:	Pn804 Ku-->(220/1000(1.5Rs))*0.005*4096...����0.005ΪIqr�ֱ���  几KW电机 ,取300？但40同步好
		0, 		0,	32767,	 6000,	// Pn277:	Pn805 极限转速 r/min  电流前馈用
		...
		3, 0x0806, 0x0B06, 0x0806,	// Pn312:	Pn840 �����������
									...
									//			hex1:����
									// 			hex2:����������
		0, 		1,	32767,	   140,	// Pn313:	Pn841 ���滻��ϵ�� = 1/[(Pi/300 * J * e-4)*Iqm/Tn],Tn��λNm,������   ���ֵС�������������ܵ�����
		0, 		0,	  50,	  15,	// Pn314:	Pn842 模块电流 10A
		0, 	  0,	 16500,	 3000,	// Pn315:	Pn843 最高转速
		0, 		1,	32767,	  303,	// Pn316:	Pn844 ����������
		0, 		1,	12000,	 500,	// Pn317:	Pn845 �额定电流  2000*0.005？
		0, 		1,	   28,	  	2,	// Pn318:	Pn846 ������
		0, 	  500,	 8192,	 4096,	// Pn319:	Pn847 ����������
		0, 		1,	  100,	   30,	// Pn320:	Pn848 �첽�϶�Ƶ��
		0, 		1,	 2500,	  227,	// Pn321:	Pn849 ��������ϵ��	26.6mV/A
		0, 		1,	30000,	 300,	// Pn322:	Pn850 电流环增益
		0, 		0,	 1000,	   20,	// Pn323:	Pn851 电流环积分
		0, 		0,	 	1,	  	0,	// Pn324:	Pn852 ģ���ϵ�
		0, 		0,	65535,	4050,	// Pn325:	Pn853 相位
		0, 		1,	   10,	  	1,	// Pn326:	Pn854 Kisp1
		0, 	   10,	 1000,	  100,	// Pn327:	Pn855 Kisp2
		0, 		0,	 16500,	 3000,	// Pn328:	Pn856 �ת��  额定转速   判断过载用
		0,	    1,	 6500, 	 400,	// Pn329:	Pn857 �Ŷ����
		0, 		0,		1,	  	1,	// Pn330:	Pn858 [0]:ȡ����ͺŲ�����ֵ��[1]ȡʵ�ʲ���ֵ
		0,      0,	 	0,	  	0,	// Pn331:	Pn859 ����
		0, 		0,	    3,	    2,	// Pn332:	Pn860 保留改为    旋变分辨率 0 =10bit,1=14bit 2=12bit 3=16bit
		0, 		0, 		3, 		2,  // Pn333:	Pn861 保留 改为  正交输出分辨率多少线  0=256线(4倍后10位）。1=4096线(4倍后14位）。2=1024线（4倍后12位）。  3= 16384 （4倍后16位65536）
		0, 		0,	 	0,		0,	// Pn334:	Pn862 ����
		0, 		0,	 	0,		0,	// Pn335:	Pn863 ����
		0, 		0,	 	0,		0,	// Pn336:	Pn864 ����
